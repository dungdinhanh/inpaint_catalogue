...
class LaionIterJsonDataset(IterableDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.anno_list = []
        for anno in os.listdir(anno_root):
    ...
    def _sample_data(self, data_info):
        ...
        with open(data_info["img_path"], "rb") as f:
            img_bytes = f.read()
    ...
    def sample_data(self, anno_info):
        with open(anno_info, "r", encoding="utf-8") as f:
            anno_str = f.read()
    ...
    def __repr__(self):
        return f"LaionIterJsonDataset(anno_root={self.anno_root}, random_mask_root={self.random_mask_list})"
